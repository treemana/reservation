...
- [1. 图书馆预约系统-API](#1-图书馆预约系统-api)
  ...
  - [1.4. 教师系统](#14-教师系统)
    ...
    - [1.4.2. 书包柜管理](#142-书包柜管理)
      ...
      - [1.4.2.5. 批量增加柜子](#1425-批量增加柜子)
      - [1.4.2.6. 批量删除柜子by id](#1426-批量删除柜子by-id)
      - [1.4.2.7. 批量删除柜子by number](#1427-批量删除柜子by-number)
      - [1.4.2.8 增加区域](#1428-增加区域)
    - [1.4.3. 学生管理](#143-学生管理)
